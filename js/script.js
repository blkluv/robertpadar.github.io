    ...
    $.ajax({
        ...
        success: function(news) {
            ...
            for(i=0; i<news['data']['results'].length; i++) {
                $('.newsSecondary').append('<div class="secondaryFlex column">' +
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            ...
                                            for(i=0; i<items.length; i++) {
                                                $('.wikiModal').append('<div class="wikiFirst">' +
        ...
        $.ajax({
            ...
            success: function(resp) {
                for(i=0; i<resp['data']['items'].length; i++) {
                    $('.nasaModalSearch').append('<div class="nasaSearch">' +
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for(var i =1; i<=response['data'].length; i++){
                    $('.nasaRoverPhotos').append('<figure class="column">'+
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    for(i=0; i<resp['data'].length; i++) {
                        $('.foodModalBody').append('<div class="photoOfTheDay">'+
